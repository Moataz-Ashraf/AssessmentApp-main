...
enum APIError: Error {
    case DecodeDataFailure, serviceProblem, success, userInfoNotMatching, userBlocked, userNotActivated, userNotAuth, missingParams, emailDublicated, passwordMissing, languageNotSupported, timezoneRequired, usernameDublicated, projectNameReuqired, NoInternetConnection
    ...
    var description: String {
        ...
        case .success:
            return "true service"
        case .userInfoNotMatching:
            return "the user information not matched “ email || password“"
        case .userBlocked:
            return "the user is block"
        case .userNotActivated:
            return "the user not activated his account"
        case .userNotAuth:
            return "the user not Auth"
        case .missingParams:
            return ""
        case .emailDublicated:
             return ""
        ...
        case .timezoneRequired:
             return ""
        case .usernameDublicated:
             return ""
        case .projectNameReuqired:
             return ""
        case .NoInternetConnection:
            return "No Internet Connection"
        case .DecodeDataFailure:
            return "One of dataTypes is changed"
        }
    }
}
